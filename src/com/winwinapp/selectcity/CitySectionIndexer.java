...
public class CitySectionIndexer implements SectionIndexer {
	...
	public CitySectionIndexer(List<CityItemInterface> contacts) {
	...
	public void initPositions(List<CityItemInterface> contacts) {
		...
		for (CityItemInterface contact : contacts) {
