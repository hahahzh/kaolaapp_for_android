...
public class CityListAdapter extends ArrayAdapter<CityItemInterface> {

	private int resource; // store the resource layout id for 1 row
	private boolean inSearchMode = false;

	private CitySectionIndexer indexer = null;

	public CityListAdapter(Context _context, int _resource,
			List<CityItemInterface> _items)
	{
		...
		Collections.sort(_items, new CityItemComparator());

		setIndexer(new CitySectionIndexer(_items));
	...
	public void showSectionViewIfFirstItem(View rowView,
			CityItemInterface item, int position)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		CityItemInterface item = getItem(position);
	...
	public void setIndexer(CitySectionIndexer indexer)
	{
	...
	public class CityItemComparator implements Comparator<CityItemInterface>
	{
		...
		@Override
		public int compare(CityItemInterface lhs, CityItemInterface rhs)
		{
